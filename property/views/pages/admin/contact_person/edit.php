<?php
if(count($contactPersonValues)):
	foreach($contactPersonValues as $data):
	endforeach;
endif;
	...
	<td>
       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<td><?php echo form_dropdown('company_id', $OptionCompany, $data->company_id, 'style="width:200px; height:35px;"'); ?></td>
			<td>
