		...
		<div id="content-table-inner">
			...
			<div id="table-content">
                ...
                <?php $i= (int) $this->uri->segment(4) + 1; foreach($appointmentValues as $appointmentValue):
				      $service_type_id = $appointmentValue->service_type_id;
				      $user_id = $appointmentValue->user_id;
					  $service_types = $this->Shows->getThisValue("id = '$service_type_id'", 'service_type');
				...
				<tr <?php if($i %2 == 0): ?> class="alternate-row" <?php endif;?>>
                    ...
                    <td><?php if(count($service_types)): foreach($service_types as $service_type): echo ucwords($service_type->type_name); endforeach; endif; ?></td>
				...
				<tr height="40"><div id="message-red"><td colspan="8"  class="red-left">No Record found...</td></div></tr>
				</table>
                <?php endif; ?>
				<?php echo form_close(); ?>
			</div>
