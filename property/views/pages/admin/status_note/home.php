			...
			<div id="table-content">
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0"  style="margin-bottom:5px;">
                    <tr>
                     ...
                     <a href="<?php echo base_url().$this->aadmin->Astatus_note_entry_uri; ?>"><img src="<?php echo base_url(); ?>public/images/add.gif" alt="<?php echo "#"; ?>" border="0" align="absmiddle"/></a>
                ...
                <?php $i = (int) $this->uri->segment(4) + 1; foreach($statusNoteValues as $statusNoteValue): 
				...
				<tr <?php if($i %2 == 0): ?> class="alternate-row" <?php endif;?>>
					<td><?php echo form_checkbox('checkbox_'.$statusNoteValue->id, $statusNoteValue->id); ?></td>
					<td><?php echo $i; ?></td>
					...
					<td>
					<a href="<?php echo base_url().$this->aadmin->Astatus_note_edit_uri.$statusNoteValue->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a onclick="return confirmSubmit()" href="<?php echo base_url().$this->aadmin->Astatus_note_delete_uri.$statusNoteValue->id; ?>" title="Delete" class="icon-2 info-tooltip"></a>
					</td>
				</tr>
				...
				<!--  end product-table................................... --> 
                 <?php  else: ?>
				<table border="0" width="100%" cellpadding="0" cellspacing="0"  style="margin-bottom:5px;">
				<tr height="40"><div id="message-red"><td colspan="9"  class="red-left">No Status Note Available Yet .. <a href="<?php echo base_url().$this->aadmin->Astatus_note_entry_uri; ?>">Add Status Note Now</a></td></div></tr>
				</table>
                <?php endif; ?>
				<?php echo form_close(); ?>
			</div>
