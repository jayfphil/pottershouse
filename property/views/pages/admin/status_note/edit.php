<?php
if(count($statusNoteValues)):
	foreach($statusNoteValues as $data):
	endforeach;
endif;
$note = array(
	'name'	   => 'note',
	...
	<td>
       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<td><?php echo form_dropdown('company_id', $OptionCompany, $data->company_id, "style='width:200px; height:35px;'  onchange='getPerson(this.value)'"); ?></td>
			<td>
        ...
        <tr>
			...
			<td><div id="person_name" style="width:200px;"><?php echo form_dropdown('contact_person_id', $OptionContactPerson, $data->contact_person_id, 'style="width:200px; height:35px;"'); ?></div></td>
			<td>
            <div class="error-left"></div>
        ...
        <tr>
			...
			<td><?php echo form_dropdown('service_type_id', $OptionServiceType,  $data->service_type_id, 'style="width:200px; height:35px;"'); ?></td>
			<td>
            <div class="error-left"></div>
		...
		<tr>
			...
			<td><?php echo form_dropdown('person_level_id', $OptionLevel, $data->person_level_id, 'style="width:200px; height:35px;"'); ?></td>
			<td>
            <div class="error-left"></div>
