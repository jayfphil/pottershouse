		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
                    ...
                    <th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'created'; ?>">Created</a></th>
					<th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'service_type'; ?>">Service</a></th>				                         
					<th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'property'; ?>">Property</a></th>
					<th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'company_name'; ?>">Company</a></th>
                    <th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'notes'; ?>">Note</a></th>			                    
					<th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'property_size'; ?>">Size</a></th>
					<th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'user'; ?>">User</a></th>
					<th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'service_status'; ?>">Status</a></th>
                    <th class="table-header-repeat line-left"><a href="<?php echo base_url().$this->aadmin->Arequest_service_sort_uri.'service_date'; ?>">Date</a></th>  
				...
				<!--  end user-table................................... --> 
                 <?php  else: ?>
				<table border="0" width="100%" cellpadding="0" cellspacing="0"  style="margin-bottom:5px;">
				<tr height="40"><div id="message-red"><td colspan="10"  class="red-left">No Service Available...</td></div></tr>
				</table>
                <?php endif; ?>
				<?php echo form_close(); ?>
			</div>
