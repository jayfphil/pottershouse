...
if(count($serviceValues)):
    foreach($serviceValues as $serviceValue):
     endforeach;
endif;
$tenant_to_attend = $serviceValue->tenant_to_attend;
if($tenant_to_attend =='yes'):
$data1 = array(
...
$company_name = array(
	...
	'id'	=> 'company_name',
        'readonly' => 'readonly',  
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->company_name
);
$property_size = array(
	'name'	=> 'property_size',
	'id'	=> 'property_size',
        'readonly' => 'readonly',  
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->property_size
);
...
$service_date = array(
	...
	'id'	=> 'service_date',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->service_date_edit
	);
...
$keys_afterword_to = array(
	...
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->keys_afterword_to
	);
...
$tenant_name = array(
	...
	'id'	=> 'tenant_name',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->tenant_name
	);
...
$tenant_contact_number = array(
	...
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->tenant_contact_number
	);
...
$document_url_link = array(
	...
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->document_url_link
	);
$amendment_link_path = array(
	'name'	=> 'amendment_link_path',
	'id'	=> 'amendment_link_path',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $serviceValue->amendment_link_path
	);
       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<td valign="top"><?php echo form_input($property_size); ?><p>&nbsp;</p>
                        ...
                        <td valign="top"><?php echo form_dropdown('service_type', $OptionServiceType, $serviceValue->service_type, 'style="width:200px; height:35px;"'); ?>
                            <p>&nbsp;</p> 
			...
			<td valign="top"><?php echo form_input($service_date); ?>
                       ...
                       <td valign="top"><?php echo form_dropdown('service_time', $OptionTime, $serviceValue->service_time, 'style="width:200px; height:35px;"'); ?>
                       <p>&nbsp;</p> 
               ...
               <tr>
                    ...
                    <td valign="top"><?php echo form_dropdown('service_duration', $OptionServiceDuration, $serviceValue->service_duration, 'style="width:200px; height:35px;"'); ?>
                    <p>&nbsp;</p> 
                    ...
                    <td valign="top"><?php echo form_dropdown('clerk_id', $OptionClerk, $serviceValue->clerk_id, 'style="width:200px; height:35px;"'); ?>
                    <p>&nbsp;</p> 
		...
		<tr>
            ...
            <td>&nbsp;</td>
              ...
              <tr>
                      ...
                      <td valign="top"><?php echo form_input($document_url_link).nbs(3); ?><img src="<?php echo base_url().'public/images/boxnet_icon.png'; ?>" height="24" width="24" alt="#" align="absmiddle" />
                        ...
                        <td valign="top"><?php echo form_dropdown('service_status', $OptionServiceStatus, $serviceValue->service_status, 'style="width:200px; height:35px;"'); ?>
                        <p>&nbsp;</p> 
          ...
          <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <?php echo form_hidden('client_id', $serviceValue->client_id); ?>
                <?php echo form_hidden('id', $serviceValue->id); ?>
