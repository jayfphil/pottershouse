       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<td>
				...
				?>
					<option value="<?php echo $PastorInfos->id;?>" <?php if($churchInfo->pastor_Id == $PastorInfos->id){ echo "selected='selected'";}?>><?php echo $PastorInfos->firstName." ".$PastorInfos->middleName." ".$PastorInfos->lastName;?></option>
				<?php
					}
				?>
				</select>
		...
		<tr>
			...
			<td>
				...
				?>
					<option value="<?php echo $RegionInfos->id;?>" <?php if($churchInfo->region_Id == $RegionInfos->id){ echo "selected='selected'";}?>><?php echo $RegionInfos->regDesc;?></option>
				<?php
					}
				?>
				</select>
		...
		<tr>
			<th valign="top"><?php echo "Select Province"; ?><span class="markcolor">*</span></th>
			<td>
				...
				?>
					<option value="<?php echo $ProvinceInfos->id;?>" <?php if($churchInfo->province_Id == $ProvinceInfos->id){ echo "selected='selected'";}?>><?php echo $ProvinceInfos->provDesc;?></option>
				<?php
					}
				?>
				</select>
		...
		<tr>
			...
			<td>
				...
				?>
					<option value="<?php echo $CityInfos->id;?>" <?php if($churchInfo->city_Id == $CityInfos->id){ echo "selected='selected'";}?>><?php echo $CityInfos->citymunDesc;?></option>
				<?php
					}
				?>
				</select>
		...
		<tr>
			<th valign="top"><?php echo "Select Barangay"; ?><span class="markcolor">*</span></th>
			<td>
				...
				?>
					<option value="<?php echo $BarangayInfos->id;?>" <?php if($churchInfo->brgy_Id == $BarangayInfos->id){ echo "selected='selected'";}?>><?php echo $BarangayInfos->brgyDesc;?></option>
				<?php
					}
				?>
				</select>
        ...
        <tr>
			<th valign="top"><?php echo "Upload Church Image"; ?><span class="markcolor"></span></th>
			<td>
				<input type="file" name="userfile" id="userfile" style="width: 280px; padding: 6px;">
	            <p>
					<?php if(!empty($churchInfo->picture)){ ?>
						<img src="<?php echo base_url();?>public/photos/church/<?php echo $churchInfo->picture?>" width="30%">
					<?php } ?>
				</p>
			</td>
			<td>
        ...
        <tr>
			...
			<td><?php echo form_textarea($schedule);?></td>
			<td>
