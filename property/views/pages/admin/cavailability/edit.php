<?php
if(count($availableValues)):foreach($availableValues as $availableValue): endforeach; endif;
$not_avail_from_date = array(
	...
	'value' =>  $availableValue->not_avail_from_date_edit
);
...
$not_avail_to_date = array(
	...
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' =>  $availableValue->not_avail_to_date_edit
);
$reason = array(
	'name'	=> 'reason',
	'id'	=> 'reason',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' => $availableValue->reason
);
?>
	...
	<td>
       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<td><?php echo form_dropdown('clerk_id', $OptionClerk,  $availableValue->clerk_id, 'style="width:200px; height:35px;"'); ?></td>
			<td>
		...
		<tr>
			...
			<td><?php echo form_dropdown('not_avail_from_time', $OptionTime,  $availableValue->not_avail_from_time, 'style="width:200px; height:35px;"'); ?></td>
			<td>
            <div class="error-left"></div>
		...
		<tr>
			<th valign="top"><?php echo "Time"; ?><span class="markcolor">*</span></th>
			<td><?php echo form_dropdown('not_avail_to_time', $OptionTime,  $availableValue->not_avail_to_time, 'style="width:200px; height:35px;"'); ?></td>
			<td>
            <div class="error-left"></div>
        ...
        <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <?php echo form_hidden('id', $availableValue->id); ?>
