...
$congregation_name = array(
	...
	'style'    => 'padding: 6px; width:280px;',
	'value'    => set_value('congregation_name')
);
       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<td>
				...
				?>
					<option value="<?php echo $teacher_info->id;?>"><?php echo $teacher_info->firstName." ".$teacher_info->middleName." ".$teacher_info->lastName;?></option>
				<?php
					}
				?>
				</select>
		...
		<tr>
			...
			<td>
				<?php echo form_input($congregation_name); ?>
			</td>
			<td>
        ...
        <tr>
			<th valign="top"><?php echo "Upload Congregation Photo"; ?><span class="markcolor"></span></th>
