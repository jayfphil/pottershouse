<?php
if(count($serviceStatusValues)):
	foreach($serviceStatusValues as $data):
	endforeach;
endif;
$status_name = array(
	'name'	=> 'status_name',
...
<tr>
	...
	<td>
       ...
       <?php if(!empty($admin_message)): ?> 
        ...
        <tr>
            <td class="green-left"><?php echo $admin_message; ?>. <a href="<?php echo base_url().$this->aadmin->Aservice_status_home_uri; ?>">View all.</a></td>
       ...
       <?php endif; ?> 
		...
		<tr>
			<th valign="top"><?php echo "Status Name"; ?><span class="markcolor">*</span></th>
			<td><?php echo form_input($status_name); ?></td>
			<td>
            <div class="error-left"></div>
			<div class="error-inner"><?php echo ucwords(form_error('status_name')); ?></div>
           </td>
		</tr>
        <tr>
            <th>&nbsp;</th>
