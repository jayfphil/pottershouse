...
$test_date = array(
	...
	'id'	   => 'test_date',
	'style'    => 'padding: 6px; width:280px;',
	'value'    => date("d-m-Y",strtotime($announcementsInfo->expirationDate))
);
$description = array(
	'name'	    => 'description',
	'id'	    => 'description',
    'class'=>'ckeditor',
	'value' =>  $announcementsInfo->description
);
...
<tr>
	...
	<td>
       ...
       <?php if(!empty($admin_message)): ?> 
        ...
        <tr>
            <td class="green-left"><?php echo $admin_message; ?>. <a href="<?php echo base_url().$this->aadmin->Announcements_home_uri; ?>">View all.</a></td>
       ...
       <?php endif; ?> 
		...
		<tr>
			<th valign="top" style="width:230px"><?php echo "Announcements Title"; ?><span class="markcolor">*</span></th>
        ...
        <tr>
			<th valign="top"><?php echo "Announcements Description"; ?><span class="markcolor">*</span></th>
		...
		<tr>
			...
			<td>
				<select name="status" id="status" style="width: 295px;padding: 6px;">
					<option value="Approved" <?php if($announcementsInfo->approvalStatus=="Approved"){ echo "selected='selected'";}?>>Approved</option>
					<option value="Rejected" <?php if($announcementsInfo->approvalStatus=="Rejected"){ echo "selected='selected'";}?>>Rejected</option>
				</select>
			</td>
			<td>
		...
		<tr>
			<th valign="top"><?php echo "Announcements Expiration Date"; ?><span class="markcolor">*</span></th>
