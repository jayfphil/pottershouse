		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr <?php if($i %2 == 0): ?> class="alternate-row" <?php endif;?>>
					...
					<a href="<?php echo base_url().$this->aadmin->Aappointment_edit_uri.$appointmentValue->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					</td>
                 </tr>
				...
				<!--  end user-table................................... --> 
                 <?php  else: ?>
				<table border="0" width="100%" cellpadding="0" cellspacing="0"  style="margin-bottom:5px;">
				<tr height="40"><div id="message-red"><td colspan="10"  class="red-left">No Appointment Available...</td></div></tr>
				</table>
                <?php endif; ?>
				<?php echo form_close(); ?>
			</div>
