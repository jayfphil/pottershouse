...
$street1 = array(
	...
	'id'	=> 'street1',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' => $propertyValue->street1
);
$street2 = array(
	'name'	=> 'street2',
	'id'	=> 'street2',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' => $propertyValue->street2
);
$town = array(
	'name'	=> 'town',
	'id'	=> 'town',
	'style' => 'height: 25px; padding: 6px 6px 0 6px; width: 186px;',
	'value' => $propertyValue->town
);
...
<tr>
	...
	<td>
       ...
       <?php if(!empty($admin_message)): ?> 
        ...
        <tr>
            <td class="green-left"><?php echo $admin_message; ?>&nbsp;&nbsp;<a href="<?php echo base_url().$this->aadmin->Aproperty_file_home_uri; ?>">View all.</a></td>
       ...
       <?php endif; ?> 
		...
		<tr>
			...
			<div class="error-inner"><?php echo ucwords(form_error('county')); ?></div>
                ...
                <tr>
                    ...
                    <td><?php echo form_dropdown('property_size', $OptionPropertySize, $propertyValue->property_size, 'style="width:200px; height:35px;"'); ?></td>
                    <td>
                    <div class="error-left"></div>
		...
		<tr>
            ...
            <td><?php echo form_dropdown('company_name', $OptionCompanyName, $propertyValue->company_name, 'style="width:200px; height:35px;"'); ?></td>
			<td>
            <div class="error-left"></div>
          ...
          <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <?php echo form_hidden('id', $propertyValue->id); ?>
