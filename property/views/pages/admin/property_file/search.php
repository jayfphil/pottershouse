...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td valign="top"><?php echo form_input($client_name_number); ?>
                        <p>&nbsp;</p>    
                        <span class="markcolor"><?php echo ucwords(form_error('client_name_number')); ?></span></td>                       
                        <td>&nbsp;</td>
                        <th valign="top"><?php echo "Post Code"; ?><span class="markcolor"></span></th>
			<td valign="top"><?php echo form_input($post_code); ?><p>&nbsp;</p> 
                           <span class="markcolor"><?php echo ucwords(form_error('post_code')); ?></span>
                        </td>
                        <td>&nbsp;</td>
		 </tr>
		<tr>
			<th valign="top"><?php echo "Street"; ?><span class="markcolor"></span></th>
			<td valign="top"><?php echo form_input($street1); ?><p>&nbsp;</p>
                        <span class="markcolor"><?php echo ucwords(form_error('street1')); ?></span>			
                       </td>
                        <td>&nbsp;</td>
                        <th valign="top"><?php echo "...."; ?><span class="markcolor"></span></th>
                        <td valign="top"><?php echo form_input($street2); ?>
                            <p>&nbsp;</p> 
                            <span class="markcolor"><?php echo ucwords(form_error('street2')); ?></span>
                        </td>
                         <td>&nbsp;</td>
		</tr>
              <tr>
			<th valign="top"><?php echo "Town"; ?><span class="markcolor"></span></th>
			<td valign="top"><?php echo form_input($town); ?>
                        <p>&nbsp;</p> 
                        <span class="markcolor"><?php echo ucwords(form_error('town')); ?></span>
                       </td>
                       <td>&nbsp;</td>
                       <th valign="top"><?php echo "County"; ?><span class="markcolor"></span></th>
                       <td valign="top"><?php echo form_input($county); ?>
                       <p>&nbsp;</p> 
                       <span class="markcolor"><?php echo ucwords(form_error('county')); ?></span>                       
                       </td>
                       <td>&nbsp;</td>
	       </tr>
               <tr>
                    <th valign="top"><?php echo "Property Size"; ?><span class="markcolor"></span></th>
                    <td valign="top"><?php echo form_dropdown('property_size', $OptionPropertySize2, set_value('property_size'), 'style="width:200px; height:35px;"'); ?>
                    <p>&nbsp;</p> 
                    ...
                    <td valign="top"><?php echo form_dropdown('company_name', $OptionCompanyName, set_value('company_name'), 'style="width:200px; height:35px;"'); ?>
                    <p>&nbsp;</p> 
