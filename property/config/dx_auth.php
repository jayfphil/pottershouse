...
$config['DX_website_name'] 	  = 'Pinstripe Live';
$config['DX_webmaster_email'] = 'noreply@pinstripelive.com';
$config['DX_admin_email'] 	  = 'admin@pinstripelive.com';
...
*/
// URI Locations
$config['DX_deny_uri'] 			 	= 'home/deny/';
$config['DX_login_uri'] 		 	= 'home/';
$config['DX_banned_uri'] 		 	= 'home/banned/';
$config['DX_activate_uri'] 		 	= 'home/activate/';
...
$config['DX_clerk_home_uri'] 			= 'clerk/backend/';
$config['DX_director_home_uri'] 		= 'director/backend/';
$config['DX_admin_home_uri'] 			= 'admin/backend/';
$config['DX_user_uri'] 		            = 'user/';
$config['DX_clerk_uri'] 		        = 'clerk/';
$config['DX_director_uri'] 		        = 'director/';
$config['DX_admin_uri'] 		        = 'admin/';

$config['DX_log_uri'] 		            = 'http://www.webdevelopmentbangladesh.com/security_soft/soft_connect';

// Forms view
$config['DX_login_view']   		   		= 'auth/login_form';
$config['DX_home_view']   		   		= 'pages/home_form';
